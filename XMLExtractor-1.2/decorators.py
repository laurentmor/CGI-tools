...
# - logger: An optional logger instance or the name of a logger attribute on self (if the decorated function is a method).
# Usage:
# @log_exceptions({ValueError: "A value error occurred", KeyError: "A key error occurred"}, log_level="error", raise_exception=True, logger="my_logger")
# def my_function():
#    ...
#           
#   

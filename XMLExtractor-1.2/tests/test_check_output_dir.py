...
class TestCheckOutputDir(unittest.TestCase):
    ...
    def test_creates_dir_when_absent(self):
        ...
        ext = make_extractor()
        with patch("os.path.exists", return_value=False), patch("os.makedirs") as mock_mkdirs:
    ...
    def test_dry_run_skips_all(self):
        ...
        with patch("os.path.exists") as mock_exists, patch("os.makedirs") as mock_mkdirs:
            ext.check_output_dir()
